  ...
  return (
    <>
      ...
      <button
        ...
        className="relative p-2 text-gray-700 hover:text-green-400 hover:bg-green-900/20 rounded-lg transition"
      >
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
        </svg>
        {unreadCount > 0 && (
          <span className="absolute -top-1 -right-1 bg-red-500 text-black text-xs font-bold rounded-full w-5 h-5 flex items-center justify-center shadow-[0_0_10px_rgba(239,68,68,0.5)]">
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="fixed right-4 top-20 w-96 max-w-[calc(100vw-2rem)] bg-gradient-to-br from-white to-gray-50 rounded-lg shadow-2xl border-2 border-green-500/50 z-50 max-h-[80vh] flex flex-col"
            >
              {/* Header */}
