    ...
    <div className="min-h-screen flex items-center justify-center p-4 bg-[#0F172A]">
      ...
      >
        <div className="text-center mb-6">
          <h1 className="text-3xl font-bold text-[#F1F5F9]">TriviaNova</h1>
          <p className="text-[#CBD5E1] text-sm mt-2">Welcome back! Login to continue</p>
        </div>
        ...
        <p className="text-center mt-4 text-[#CBD5E1]">
          Don't have an account? <Link to="/register" className="text-[#F1F5F9] font-semibold hover:opacity-70">Register</Link>
        </p>
      </motion.div>
    </div>
  );
